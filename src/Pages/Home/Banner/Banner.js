...
const Banner = () => {
    return (
        <div class='bg-yellow-400 banner-polyfon pt-8 md:pt-8'>
            <div class='container mx-auto md:flex items-center py-14 md:py-16 px-4 md:px-8'>
                <div class=''>
                    ...
                    <button class='px-5 ring-2 py-2 rounded-lg bg-black text-slate-50'>Hire Us</button>
                </div>
